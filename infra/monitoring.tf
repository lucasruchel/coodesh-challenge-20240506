    ...
    widgets = [
      ...
      },
      {
            ...
            "properties": {
                ...
                "query": "SOURCE 'access_log' | fields @timestamp, @message, @logStream, @log | sort @timestamp desc | limit 1000" ,
                "view": "table"
            }
        },
        {
            ...
            "properties": {
                ...
                "query": "SOURCE 'error_log' | fields @timestamp, @message, @logStream, @log | sort @timestamp desc | limit 1000" ,
                "view": "table"
            }
        }
        ,
